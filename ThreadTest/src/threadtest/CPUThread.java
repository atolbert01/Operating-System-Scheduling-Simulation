 ...
 * Aaron Tolbert-Smith
 */
public class CPUThread extends ThreadObject implements Runnable {
    ...
    public CPUThread(String threadName) {
    ...
    public void run() {
        ...
        //This loop will find and display the first 1000 primes
        for (int i = 2; i <= 1001;) {
